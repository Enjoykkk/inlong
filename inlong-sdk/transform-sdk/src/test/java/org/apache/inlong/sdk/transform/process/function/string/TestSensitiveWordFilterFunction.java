...
public class TestSensitiveWordFilterFunction extends AbstractFunctionStringTestBase {
    ...
    public void testSensitiveWordFilterFunction() throws Exception {
        ...
        // case1: sensitive_word_filter('Hello bad world', 'bad', '***')
        ...
        // case2: sensitive_word_filter('good morning', 'bad,evil', '***') -> no match
        ...
        // case3: sensitive_word_filter('bad evil text', 'bad,evil', '***') -> multiple words
        ...
        // case4: sensitive_word_filter('hello world', '', '***') -> empty sensitive_words
        ...
        // case5: sensitive_word_filter('badword here', 'badword', '') -> replace with empty
        ...
        // case6: sensitive_word_filter('bad bad bad', 'bad', '***') -> repeated word
        List<String> output6 = processor.transform("bad bad bad|bad|***", new HashMap<>());
        Assert.assertEquals(1, output6.size());
        Assert.assertEquals("result=*** *** ***", output6.get(0));

        // case7: sensitive_word_filter(' bad , evil ', ' bad , evil ', '***')
        // -> trimmed words: 'bad' and 'evil'
        List<String> output7 = processor.transform("bad and evil| bad , evil |***", new HashMap<>());
        Assert.assertEquals(1, output7.size());
        Assert.assertEquals("result=*** and ***", output7.get(0));
    }
}
